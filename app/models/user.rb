...
class User < ApplicationRecord
  ...
  has_attached_file :cover,  styles: {thumb: "400x300", medium: "800x600"}, default_url: "/images/:style/missing-cover.png"
  ...
  def validate_username_regex
    unless username =~ /\A[a-zA-Z]*[a-zA-Z][a-zA-Z0-9_]*\z/
      ...
      errors.add(:username,"El username solo puede contener letras, números y guión bajo")
    end    
  end
